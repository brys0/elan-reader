var _a, _b;
import { av as tick } from "./runtime.CBJxRLJu.js";
import { w as writable } from "./index.C4UdWAqn.js";
...
const base = ((_a = globalThis.__sveltekit_1jhx82g) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_1jhx82g) == null ? void 0 : _b.assets) ?? base;
const version = "1743470875544";
    ...
    if (hash2 !== void 0 && nonhash === strip_hash(location)) {
      ...
      if (current_hash === hash2) {
        ...
        if (hash2 === "" || hash2 === "top" && a.ownerDocument.getElementById("top") === null) {
          ...
          (_a3 = a.ownerDocument.getElementById(decodeURIComponent(hash2))) == null ? void 0 : _a3.scrollIntoView();
        }
        return;
      }
