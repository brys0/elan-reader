...
<div
    class="flex flex-col gap-10 items-center p-8 w-full h-full justify-between"
>
    <Button
        onclick={settingsModal.open}
        size="icon"
        variant="outline"
        class="absolute top-4 right-4 max-w-9 max-h-9 z-[9999]"
    >
